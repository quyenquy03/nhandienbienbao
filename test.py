...
def getCalssName(classNo):
    if   classNo == 0: return 'Max speed 20 km/h'
    elif classNo == 1: return 'Max speed 30 km/h'
    elif classNo == 2: return 'Max speed 50 km/h'
    elif classNo == 3: return 'Max speed 60 km/h'
    elif classNo == 4: return 'Max speed 70 km/h'
    elif classNo == 5: return 'Max speed 80 km/h'
    elif classNo == 6: return 'End of max speed 80 km/h'
    elif classNo == 7: return 'Max speed 100 km/h'
    elif classNo == 8: return 'Max speed 120 km/h'
...
def getLargestContour(img, imgContour):
    ...
    if largest_contour is not None and largest_area > 1000:  # Kiểm tra nếu có đường viền lớn hơn 1000
        ...
        # Cắt vùng lớn nhất
        cropped_img = imgContour[y:y + h, x:x + w]
...
while True:
    ...
    img = getLargestContour(img, imgOrignal)
    if img is not None:
